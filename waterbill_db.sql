--
-- File generated with SQLiteStudio v3.2.1 on Fri Jan 25 12:06:25 2019
--
...
INSERT INTO Customer (cid, nic, address_1, address_2, address_3, gid, preMeter, currentMeter, TotalOutstandingAmount, MeterNo, lastPayment, cname, CFirstName, lastPaymentDate, InitialFeeTotal, InitialReceived) VALUES (1, '883512847v', 'ertert', 'ertert', 'ertret', 'up', 0, 17, 300.0, 5646456, 1100.0, 'ffg', 'Samith', '2019/01/22', 10000.0, 700.0);
INSERT INTO Customer (cid, nic, address_1, address_2, address_3, gid, preMeter, currentMeter, TotalOutstandingAmount, MeterNo, lastPayment, cname, CFirstName, lastPaymentDate, InitialFeeTotal, InitialReceived) VALUES (2, '883512848v', 'sdfdf', 'sdf', 'dsfd', 'up', 0, 0, 0.0, 5435, 0.0, 'sdfds', 'sdfds', NULL, 10000.0, 10000.0);
INSERT INTO Customer (cid, nic, address_1, address_2, address_3, gid, preMeter, currentMeter, TotalOutstandingAmount, MeterNo, lastPayment, cname, CFirstName, lastPaymentDate, InitialFeeTotal, InitialReceived) VALUES (3, '882311333v', 'cfdgdf', 'dfgd', 'fgdf', 'up', 0, 0, 0.0, 334443, 0.0, 'erter', 'ertret', NULL, 1000.0, 1000.0);
