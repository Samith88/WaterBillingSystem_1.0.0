--
-- File generated with SQLiteStudio v3.1.1 on Mon Jan 7 08:08:42 2019
--
...
-- Table: Customer
CREATE TABLE Customer (cid STRING (10) PRIMARY KEY NOT NULL, nic STRING (10) UNIQUE NOT NULL, address_1 STRING (30), address_2 STRING (30), address_3 STRING (30), gid STRING (10) REFERENCES "group" (gid), preMeter INTEGER, currentMeter INTEGER, TotalOutstandingAmount DOUBLE (5, 2), MeterNo INTEGER, lastPayment DOUBLE (5, 2), cname STRING (60), CFirstName STRING (15));
INSERT INTO Customer (cid, nic, address_1, address_2, address_3, gid, preMeter, currentMeter, TotalOutstandingAmount, MeterNo, lastPayment, cname, CFirstName) VALUES (1, '883512847v', '"Sinha Sevana"', 'Pananwala', 'Thalatuoya', 1, 0, 10, 100, 1212121, 100, NULL, NULL);
INSERT INTO Customer (cid, nic, address_1, address_2, address_3, gid, preMeter, currentMeter, TotalOutstandingAmount, MeterNo, lastPayment, cname, CFirstName) VALUES (2, '343434456v', 'retret', 'ertret', 'ertrt', 4, 2, 44, 454, 54545, 45, NULL, NULL);
INSERT INTO Customer (cid, nic, address_1, address_2, address_3, gid, preMeter, currentMeter, TotalOutstandingAmount, MeterNo, lastPayment, cname, CFirstName) VALUES (3, '454354343v', 'fdgfdgfd', 'fdgfdg', 'dfgdfgfdg', 1, NULL, NULL, NULL, 0, NULL, 'sam dissa', NULL);
